...
#include "genesis/uiddMainNetwork.cpp"
...
#include "genesis/test/uiddTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
    ...
    {
    //Client genesis
    case Network::uiddMainNetwork: return c_genesisInfoUiddMainNetwork;
    case Network::MainNetwork: return c_genesisInfoMainNetwork;
    case Network::Ropsten: return c_genesisInfoRopsten;

    //Test genesis
    case Network::uiddTestNetwork: return c_genesisInfoUiddTestNetwork;
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
    switch (_n)
    {
    case Network::uiddMainNetwork: return c_genesisStateRootUiddMainNetwork;
    case Network::uiddTestNetwork: return c_genesisStateRootUiddTestNetwork;
