...
////////////////////////////////////////////////////////////// // uidd
    void setUiddSchedule(EVMSchedule _uiddSchedule) const { uiddSchedule = _uiddSchedule; }

    EVMSchedule& getUiddSchedule() const { return uiddSchedule; }
...
private:
    ...
    mutable EVMSchedule uiddSchedule; // uidd
